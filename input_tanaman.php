...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="User-Smartani/input_tanaman.css">
</head>
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (isset($_FILES['gambar'])) {
            ...
            $gambar_path = 'lokasi_upload/' . $gambar;
            ...
            if (move_uploaded_file($gambar_tmp, $gambar_path)) {
                ...
                echo "Gagal mengunggah gambar. <a href='index.html'>Kembali</a>";
            }
        } else {
